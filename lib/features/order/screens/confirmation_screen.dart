...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: ConfirmationColors.background,
      appBar: AppBar(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Order not found',
            style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: ConfirmationColors.textPrimary),
          ),
          const SizedBox(height: 8),
          Text(
            'We couldn\'t find your order details',
            style: GoogleFonts.poppins(fontSize: 14, color: ConfirmationColors.textSecondary),
          ),
          const SizedBox(height: 24),
          ElevatedButton(
            onPressed: () => Navigator.pushNamedAndRemoveUntil(context, AppRoutes.home, (route) => false),
            style: ElevatedButton.styleFrom(
              backgroundColor: ConfirmationColors.primary,
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: ConfirmationColors.success.withOpacity(0.1),
              shape: BoxShape.circle,
            ),
            child: Icon(Icons.check_circle, size: 50, color: ConfirmationColors.success),
          ),
          const SizedBox(height: 16),
          Text(
            ...
            style: GoogleFonts.poppins(
              ...
              color: ConfirmationColors.textPrimary,
            ),
          ),
          const SizedBox(height: 8),
          Text(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: ConfirmationColors.border),
            ),
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text('Order ID', style: GoogleFonts.poppins(color: ConfirmationColors.textSecondary)),
                    Text(
                      widget.orderId ?? order['orderId'] ?? 'N/A',
                      style: GoogleFonts.poppins(fontWeight: FontWeight.w600, color: ConfirmationColors.primary),
                    ),
                  ],
                ),
                const Divider(height: 24, color: ConfirmationColors.border),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Payment Method', style: GoogleFonts.poppins(color: ConfirmationColors.textSecondary)),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Order Date', style: GoogleFonts.poppins(color: ConfirmationColors.textSecondary)),
                    Text(
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold, color: ConfirmationColors.primary),
                    ),
                  ],
                ),
              ],
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('Quantity: ${item['quantity'] ?? 1}', style: GoogleFonts.poppins(fontSize: 12, color: ConfirmationColors.textSecondary)),
              ],
            ),
          ),
          Text(
